...
Status: Stage 0 near its gate — 31 concepts with every follow-up edge resolving, behavior
routing, per-behavior composition, the output guardrail, the streamed web demo, and a 47-case
