...
The caveats are real. Transcript abundance and protein abundance are correlated but not
equivalent, so disagreement may reflect biology rather than a bad reagent. The comparison also
requires samples where the protein actually varies — a panel in which everything expresses the
target similarly cannot distinguish a selective antibody from an unselective one.
